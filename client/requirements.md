...
- User state is persisted in localStorage via Zustand so progress isn't lost on reload.
- The UI relies heavily on Tailwind CSS for layout and Framer Motion for immersive interactions.
